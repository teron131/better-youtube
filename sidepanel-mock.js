...
if (typeof chrome === "undefined" || !chrome.runtime) {
    window.chrome = {
        runtime: {
            ...
            onMessage: {
                addListener: () =>
                    console.log("Mock runtime.onMessage.addListener"),
                removeListener: () =>
        ...
        tabs: {
            ...
            onUpdated: {
                addListener: () =>
                    console.log("Mock tabs.onUpdated.addListener"),
                removeListener: () =>
                    console.log("Mock tabs.onUpdated.removeListener"),
            },
            onActivated: {
                addListener: () =>
                    console.log("Mock tabs.onActivated.addListener"),
                removeListener: () =>
