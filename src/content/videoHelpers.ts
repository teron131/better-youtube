...
export async function executeScrapeForAutoGen(videoId: string): Promise<boolean> {
  ...
  if (result.status !== "success") {
    console.log(`[Auto-gen] Scrape skipped for ${videoId}; stopping auto-caption generation.`);
    return false;
  }
