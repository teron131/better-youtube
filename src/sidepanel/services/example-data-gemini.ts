export const exampleSummaryGemini = {
  chapters: [
    ...
    },
    {
      ...
      description:
        "The resolution of a lithography system is governed by the Rayleigh equation, where the smallest feature size is proportional to the wavelength of light divided by the numerical aperture (NA). To create smaller circuits, engineers must either find shorter wavelengths or increase the system's NA. This led to the pursuit of Extreme Ultraviolet (EUV) light, which has a wavelength of just 13.5nm—more than ten times shorter than previous standards.",
    },
    {
      startTime: "07:11",
      endTime: "14:15",
    ...
    },
    {
      ...
      description:
        "ASML's machines move silicon wafers and patterns (reticles) at accelerations exceeding 20g with nanometer precision. The newest generation of machines, known as High NA, increases the numerical aperture from 0.33 to 0.55. This improvement allows for the etching of features as small as 8nm, enabling the creation of more powerful and energy-efficient processors for AI and mobile devices.",
    },
    {
      startTime: "41:01",
      endTime: "45:59",
