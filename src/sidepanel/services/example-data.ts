...
export const exampleData: StreamingProcessingResult = {
  ...
  transcript:
    "What if, all of the world's biggest problems from climate change, to curing diseases, to disposal of plastic waste, what if they all had the same solution? A solution so tiny it would be invisible. I'm inclined to believe this is possible, thanks to a recent breakthrough that solved one of the biggest problems of the last century. How to determine the structure of a protein? - It's been described to me as equivalent to Fermat's last theorem, but for biology. - Over six decades, tens of thousands[truncated for example]",
  summary: {
    ...
    keywords: ["AlphaFold", "protein folding", "AI"],
    target_language: "en",
  },
  quality: {
    completeness: {
      rate: "Pass",
      reason:
        "The summary covers all key aspects of the provided content, from historical challenges to modern AI breakthroughs and future implications.",
    },
    structure: {
      rate: "Pass",
      reason:
        "The output perfectly adheres to the specified schema, including the correct formatting for title, summary, chapters, takeaways, and keywords. Takeaways are simple arrays as requested.",
    },
    no_garbage: {
      rate: "Pass",
      reason:
        "No promotional or meaningless content is present in the summary. It focuses solely on the scientific and historical aspects of protein folding and AI.",
    },
    meta_language_avoidance: {
      rate: "Pass",
      reason:
        "The summary successfully avoids meta-language phrases such as 'This chapter introduces' or 'This section covers', maintaining an objective, article-like tone.",
    },
    useful_keywords: {
      rate: "Pass",
      reason:
        "The keywords 'AlphaFold', 'protein folding', and 'AI' are highly relevant and useful for highlighting the core topics of the summary.",
    },
    correct_language: {
      rate: "Pass",
      reason:
        "The content is entirely in English, matching the requested target language and maintaining natural fluency.",
    },
  },
  iterationCount: 1,
  chunksProcessed: 12,
