...
function buildMatchedRowFromArtificialAnalysisModel(
	...
	const medianSpeed =
		typeof artificialAnalysisModel.median_speed === "number"
			? artificialAnalysisModel.median_speed
			: null;
	const medianTime =
		typeof artificialAnalysisModel.median_time === "number"
			? artificialAnalysisModel.median_time
			: null;
	const logo =
