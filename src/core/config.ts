...
export async function loadConfig(): Promise<AppConfig> {
    ...
    return {
        ...
        autoGenerate:
            result[STORAGE_KEYS.AUTO_GENERATE] ?? DEFAULTS.AUTO_GENERATE,
        showSubtitles:
            result[STORAGE_KEYS.SHOW_SUBTITLES] ?? DEFAULTS.SHOW_SUBTITLES,
        captionFontSize:
            result[STORAGE_KEYS.CAPTION_FONT_SIZE] ??
            DEFAULTS.CAPTION_FONT_SIZE,
        summaryFontSize:
            result[STORAGE_KEYS.SUMMARY_FONT_SIZE] ??
